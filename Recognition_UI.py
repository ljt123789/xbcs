...
from datasets.BloodCells.label_name import Label_list
...
class Detection_UI:
    ...
    def __init__(self):
        ...
        # 加载训练的模型权重
        self.model.load_model(model_path=abs_path("weights/blood-yolov8n.pt", path_type="current"))
        # 为模型中的类别重新分配颜色
        self.colors = [[random.randint(0, 255) for _ in range(3)] for _ in
